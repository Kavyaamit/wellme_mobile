...
import com.wellme.adapter.BlogLikeListAdapter
...
class ViewAllBlogFragment : Fragment(), View.OnClickListener{
    ...
    var blog_like_Adapter : BlogLikeListAdapter? = null
    var blog_like_list : List<TestimonialLikeDTO> = ArrayList()
            ...
            override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>) {
                ...
                if(!UtilMethod.instance.isStringNullOrNot(response1)){
                    ...
                    if(object1!=null){
                        ...
                        if(blog_list!=null){
                            blogAdapter = AllBlogAdapter(requireContext(), blog_list,onItemClickCallbackLike , onItemClickCallbackComment,onItemClickCallback,onItemClickLikeCount,onItemClickCommentCount, blog_id)
    ...
    private val onItemClickLikeCount : OnItemClickListener.OnItemClickCallback = object : OnItemClickListener.OnItemClickCallback{
        ...
        override fun onItemClicked(view: View?, position: Int) {
            blog_id = blog_list.get(position).id
    ...
    fun callGetLikeListAPI(){
        ...
        service.getBlogLikeList("Bearer "+access_token,blog_id).enqueue(object :
            Callback<ResponseBody> {
            ...
            override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>) {
                ...
                if(!UtilMethod.instance.isStringNullOrNot(response1)){
                    ...
                    if(object1!=null){
                        var gson : Gson = Gson()
                        blog_like_list = gson.fromJson(object1.getJSONArray("user_list").toString(), Array<TestimonialLikeDTO>::class.java).toList()
                        showLikeDialog()
    ...
    fun setLikeListAdapter(){
        ...
        blog_like_Adapter = BlogLikeListAdapter(requireContext(), blog_like_list)
        if(blog_like_list!=null){
            rv_like_list?.adapter = blog_like_Adapter
        }
