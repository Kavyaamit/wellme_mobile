...
class WorkingSchedular : JobService(){
    ...
    override fun onStartJob(params: JobParameters?): Boolean {
        ...
        if(!UtilMethod.instance.isStringNullOrNot(s_reminder)) {
            ...
            if(reminder_old_list!=null){
                reminderDTO = reminder_old_list.get(1)
                if(reminderDTO!=null){
        ...
        if(!UtilMethod.instance.isStringNullOrNot(s_time)){
            var componentName : ComponentName = ComponentName(applicationContext, WorkingSchedular::class.java)
    ...
    fun createNotification() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            builder.setContentTitle("Workout") // required
                .setSmallIcon(R.drawable.logo) // required
                .setContentText("Please start workout for your health") // required
                .setDefaults(Notification.DEFAULT_ALL)
                .setAutoCancel(true)
                .setContentIntent(pendingIntent)
                .setTicker("Please start workout for your health")
    ...
    fun sendNotification(
        ...
        try {
            notificationBuilder.setContentTitle("Workout")
            notificationBuilder.setContentText("Please start workout for your health")
            //             notificationBuilder.setLargeIcon(bitmap);
        } catch (e: Exception) {
            e.printStackTrace()
        }
        ...
        notificationBuilder.setStyle(NotificationCompat.BigTextStyle().bigText("Please start workout for your health"))
