...
import com.wellme.R
import com.wellme.dto.StateDTO
import com.wellme.utils.OnItemClickListener

class StateAdapter(var context: Context, var state_list : List<StateDTO>,var state_filterlist : MutableList<StateDTO>, var onItemClickCallback: OnItemClickListener.OnItemClickCallback, var pos : Int, var id : String) : RecyclerView.Adapter<StateAdapter.ViewHolder>(){
    ...
    override fun getItemCount(): Int {
        return state_filterlist.size
    }

    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        var dto : StateDTO = state_filterlist.get(position)
