...
class AllBlogAdapter(var context : Context, var list : List<BlogDTO>, var onItemClickCallbackLike: OnItemClickListener.OnItemClickCallback, var onItemClickCallbackComment: OnItemClickListener.OnItemClickCallback, var onItemClickCallback: OnItemClickListener.OnItemClickCallback, var selected_id : String?) : RecyclerView.Adapter<AllBlogAdapter.ViewHolder>(){
