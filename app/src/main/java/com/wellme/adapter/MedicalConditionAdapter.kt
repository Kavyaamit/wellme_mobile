...
class MedicalConditionAdapter(var context1 : Context, var medical_list : List<MedicalConditionDTO>, var medical_filterlist : MutableList<MedicalConditionDTO>, var onItemClickCallback: OnItemClickListener.OnItemClickCallback, var pos : Int, var id : String) : RecyclerView.Adapter<MedicalConditionAdapter.ViewHolder>(){
