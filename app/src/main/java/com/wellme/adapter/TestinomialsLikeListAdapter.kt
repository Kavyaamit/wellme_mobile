...
class TestinomialsLikeListAdapter(var context: Context, var like_list: List<TestimonialLikeDTO>) : RecyclerView.Adapter<TestinomialsLikeListAdapter.ViewHolder>(){
