...
class OfferAdapter(var context: Context, var subscribe_list: List<OfferListDTO>) : PagerAdapter(){
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        var view : View = LayoutInflater.from(context).inflate(R.layout.item_offer_home, container, false)
        var dto : OfferListDTO = subscribe_list.get(position)
